    ...
    >
      ...
      <button
        onClick={scrollToNext}
          className="absolute bottom-8 md:bottom-12 left-1/2 -translate-x-1/2 text-white hover:scale-125 transition-all duration-300 z-10 animate-bounce group cursor-pointer"
        aria-label="Rolar para baixo"
      >
        <div className="flex flex-col items-center gap-2">
          <ChevronDown className="w-8 md:w-10 h-8 md:h-10 drop-shadow-2xl group-hover:drop-shadow-[0_0_8px_rgba(242,203,5,0.8)] transition-all" />
        </div>
      </button>
    </section>
  )
