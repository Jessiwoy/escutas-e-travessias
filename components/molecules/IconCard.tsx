...
export const IconCard = ({ icon, title, description }: IconCardProps) => {
  return (
    <div className="h-full flex flex-col items-start gap-4 p-6 md:p-8 bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
